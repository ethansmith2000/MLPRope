#!/usr/bin/env python
"""Queue Phase-36 calibration or 20k runs through shared gpu-claim."""
...
CONFIG_ROOT = REPO_DIR / "sweep_configs" / "phase36_direct_carrier_20k"
...
def main() -> int:
    ...
    phase = "calibration" if args.calibration else "20k"
    log_dir = REPO_DIR / "logs" / "phase36_direct_carrier_20k" / phase
