#!/usr/bin/env python
"""Run Phase 45 through the shared lifetime GPU claimer."""
...
LOG_DIR = REPO_DIR / "logs" / "phase45_novel_static_maps"
...
def _run(*, preflight: bool, owner: str, gpu: str) -> int:
    ...
    if len(configs) != 6:
        raise SystemExit(f"Expected 6 configs in {config_dir}, found {len(configs)}")
