#!/usr/bin/env python
"""Run Phase 44 through the shared lifetime GPU claimer."""
...
LOG_DIR = REPO_DIR / "logs" / "phase44_input_adapters"
...
def _run(*, preflight: bool, owner: str, gpu: str) -> int:
    ...
    expected = 2 if preflight else 3
...
def main() -> int:
    ...
    parser.add_argument("--gpu", default="0,1,2,3,4,6,7")
